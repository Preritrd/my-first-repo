...
// ----------------------------------------------
// 🔍 Glob Pattern Cheatsheet: * vs **
// ----------------------------------------------

/*
  *  => Matches any file or folder name (but only in the current folder)
  ** => Matches any file or folder name recursively (including subfolders)

  ✅ Examples:

  1. './views/*.ejs'
     - Matches:        views/index.ejs, views/home.ejs
     - Doesn't match:  views/partials/header.ejs

  2. './views/**/*.ejs'
     - Matches: views/index.ejs
                views/partials/header.ejs
                views/partials/navs/menu.ejs
     - ✅ Includes files in all subfolders

  3. '*.html'
     - Matches: All `.html` files in the current folder only

  4. '**/*.html'
     - Matches: All `.html` files in current and all subfolders

  📌 Use Cases:
  - For Prettier, ESLint, or build tools like Webpack or Gulp
  - For watching files with nodemon (e.g., `nodemon --watch views/**/*`)
